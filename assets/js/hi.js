var hi = {
    ...
    //groupColors: ['#03A3C8', '#0FB186', '#FAB700', '#FA8100', '#EE3345', '#DBE2E6'],
    //groupColors: ['#2C5989', '#6598C3', '#F5D25D', '#F17743', '#C0273B', '#DBE2E6'],
    //groupColors: ['#1FD959', '#00EBD7', '#0ACCEA', '#FFAF59', '#C0273B', '#DBE2E6'],
    ...
    updateLegend: function(){
        var _this = hi;
        var groupColors = _this.groupColors;
